...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Sydpakcoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Sydpakcoin</b> version", 0));
...
"Copyright \302\251 2014 The Sydpakcoin developers", 0));
